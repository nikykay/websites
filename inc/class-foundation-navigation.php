...
function fn_add_custom_dropdown_class( $classes, $item ) {
...
add_filter( 'nav_menu_css_class', 'fn_add_custom_dropdown_class', 10, 2 );
...
function fn_add_class_to_link( $atts, $item ) {
...
add_filter( 'nav_menu_link_attributes', 'fn_add_class_to_link', 10, 2 );